...
/**
 * 100 real, individually-sourced antisemitic incidents (2020 onward) across
...
export const SOURCED_INCIDENTS: Incident[] = [
  ...
  {
    id: 'src-002', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2026-07-24T12:00:00Z', created_at: '2026-07-24T12:00:00Z',
    neighborhood: 'Pasadena', lat: 34.1663, lng: -118.1054,
    description:
      'A community-resilience mural painted by congregation children at the fire-destroyed Pasadena Jewish Temple and Center site (North Altadena Drive) was defaced with multiple swastikas and the words \'Zionism is not welcome\'; the Sheriff\'s Department investigated it as a hate crime.',
    source_name: 'NBC Los Angeles', source_url: 'https://www.nbclosangeles.com/news/local/hate-crime-probe-underway-after-antisemitic-markings-found-in-pasadena/3921627/',
  },
  {
    id: 'src-003', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2026-07-24T12:00:00Z', created_at: '2026-07-24T12:00:00Z',
    neighborhood: 'Pasadena / Altadena', lat: 34.1706, lng: -118.0966,
    description:
      'A community mural at the fire-ravaged Pasadena Jewish Temple and Center was defaced with multiple swastikas and the message "Zionism is not welcome." The mural had been created as a response to an earlier antisemitic attack at the same site; the Sheriff\'s Department opened an investigation.',
    source_name: 'Pasadena Now', source_url: 'https://pasadenanow.com/main/community-mural-created-in-response-to-antisemitism-defaced-at-pasadena-synagogue',
  },
  {
    id: 'src-004', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-005', category: 'assault', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-006', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2026-04-29T12:00:00Z', created_at: '2026-04-29T12:00:00Z',
    neighborhood: 'Pico-Robertson', lat: 34.0525, lng: -118.3895,
    description:
      'A man in traditional Jewish clothing walking home from a synagogue was grabbed by the neck and thrown to the ground in an alley behind the Adas Torah synagogue; the attacker shouted "Free Palestine." The LAPD investigated it as a suspected hate crime.',
    source_name: 'NBC Los Angeles', source_url: 'https://www.nbclosangeles.com/news/local/man-attacked-pico-robertson-hate-crime-investigation/3883561/',
  },
  {
    id: 'src-007', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-008', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-009', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-010', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2026-01-12T12:00:00Z', created_at: '2026-01-12T12:00:00Z',
  ...
  {
    id: 'src-011', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-012', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-013', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2025-09-28T12:00:00Z', created_at: '2025-09-28T12:00:00Z',
    neighborhood: 'Glendale', lat: 34.1385, lng: -118.234,
    description:
      'Swastikas were drawn in chalk on a resident\'s driveway and on other public and private property in Glendale\'s Adams Hill neighborhood, including on a fire hydrant in the 800 block of E. Palmer Avenue; Glendale police investigated it as a suspected hate crime.',
    source_name: 'NBC Los Angeles', source_url: 'https://www.nbclosangeles.com/news/local/swastikas-glendale-hydrant-police/3784617/',
  },
  {
    id: 'src-015', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2025-09-21T12:00:00Z', created_at: '2025-09-21T12:00:00Z',
    neighborhood: 'Long Beach', lat: 33.7738, lng: -118.177,
    description:
      'A utility box outside the Long Beach Pride headquarters was defaced with anti-LGBTQ and antisemitic graffiti, including a swastika. Long Beach police investigated and the city removed the graffiti.',
    source_name: 'CBS Los Angeles', source_url: 'https://www.cbsnews.com/losangeles/news/long-beach-pride-anti-lgbtq-antisemitic-graffiti/',
  },
  {
  ...
  {
    id: 'src-020', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2025-08-31T12:00:00Z', created_at: '2025-08-31T12:00:00Z',
  ...
  {
    id: 'src-025', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2025-08-11T12:00:00Z', created_at: '2025-08-11T12:00:00Z',
    neighborhood: 'Woodland Hills', lat: 34.1755, lng: -118.601,
    description:
      'The Israeli-American Council national headquarters in Woodland Hills was defaced with a swastika, SS lightning bolts and the word "burn," with additional hateful graffiti on a nearby bridge and 101 Freeway on-ramp. The LAPD investigated it as a possible hate crime.',
    source_name: 'NBC Los Angeles', source_url: 'https://www.nbclosangeles.com/news/local/anti-semitic-vandalism-spotted-in-woodland-hills/3762375/',
  },
  {
  ...
  {
    id: 'src-028', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-029', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2025-05-19T12:00:00Z', created_at: '2025-05-19T12:00:00Z',
    neighborhood: 'Beverly Hills', lat: 34.0745, lng: -118.403,
    description:
      'On the 400 block of North Roxbury Drive, a woman made a Nazi salute and shouted "Heil Hitler" while a male companion drove an SUV displaying antisemitic messages. Beverly Hills police questioned both individuals and forwarded a report to detectives.',
    source_name: 'Beverly Press & Park Labrea News', source_url: 'https://beverlypress.com/2025/05/couple-questioned-after-video-shows-antisemitic-behavior/',
  },
  {
    id: 'src-030', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-032', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-035', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2024-07-25T12:00:00Z', created_at: '2024-07-25T12:00:00Z',
  ...
  {
    id: 'src-036', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2024-07-25T12:00:00Z', created_at: '2024-07-25T12:00:00Z',
    neighborhood: 'Fairfax/Melrose', lat: 34.0838, lng: -118.348,
    description:
      'Two hooded suspects smashed windows at Congregation Ahavas Israel on Melrose Avenue late at night, the second vandalism at the synagogue within a few weeks; LAPD\'s Wilshire Division investigated it as a possible hate crime.',
    source_name: 'FOX 11 Los Angeles', source_url: 'https://www.foxla.com/news/hollywood-synagogue-vandalized-twice-weeks',
  },
  {
    id: 'src-037', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-043', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2024-04-07T12:00:00Z', created_at: '2024-04-07T12:00:00Z',
    neighborhood: 'Santa Monica (Pico Neighborhood)', lat: 34.0262, lng: -118.4665,
    description:
      'Antisemitic graffiti was found on sidewalks, trees and light posts near Pico and Cloverfield boulevards. Santa Monica police investigated and expedited removal; no arrests were reported.',
    source_name: 'Santa Monica Patch', source_url: 'https://patch.com/california/santamonica/antisemitic-graffiti-found-throughout-santa-monica-police',
  },
  {
    id: 'src-045', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-049', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2024-01-06T12:00:00Z', created_at: '2024-01-06T12:00:00Z',
    neighborhood: 'Woodland Hills', lat: 34.1865, lng: -118.5945,
    description:
      'Multiple Jewish-owned businesses in the 20900 block of Victory Boulevard had windows smashed with rocks and cement bricks in an overnight spree; some rocks were inscribed with messages, and LAPD investigated it as a possible antisemitic hate crime.',
    source_name: 'Los Angeles Blade', source_url: 'https://www.losangelesblade.com/2024/01/07/hate-crime-investigation-in-vandalism-of-jewish-owned-businesses/',
  },
  {
    id: 'src-050', category: 'online_threat', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-051', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-055', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-056', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2023-11-24T12:00:00Z', created_at: '2023-11-24T12:00:00Z',
    neighborhood: 'Burbank', lat: 34.19, lng: -118.3095,
    description:
      'Temple Emanu El in Burbank (near N. Glenoaks Blvd and Amherst Dr) was spray-painted with a large swastika and an Iron Cross; suspect Klinton Allister Dion was later charged in a multi-site Burbank/Glendale Nazi-graffiti spree that also hit an apartment complex, church and businesses.',
    source_name: 'CBS News Los Angeles', source_url: 'https://www.cbsnews.com/losangeles/news/burbank-police-search-for-suspect-that-spray-painted-swastikas-on-synagogue',
  },
  {
    id: 'src-057', category: 'vandalism', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-058', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-060', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-061', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-062', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2023-10-25T12:00:00Z', created_at: '2023-10-25T12:00:00Z',
    neighborhood: 'Studio City', lat: 34.1385, lng: -118.396,
    description:
      'A man tried to kick down the door of a Jewish family\'s home in the 3000 block of Laurel Canyon Boulevard while yelling \'Free Palestine\' and \'Kill Jews, kill Jews.\' Suspect Daniel Garcia, 43, was arrested and charged with criminal threats, attempted burglary and vandalism with hate-crime allegations.',
    source_name: 'Crosstown LA', source_url: 'https://xtown.la/2023/11/13/anti-jewish-hate-crimes-surge-in-los-angeles/',
  },
  {
    id: 'src-063', category: 'other', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-065', category: 'other', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2023-06-19T12:00:00Z', created_at: '2023-06-19T12:00:00Z',
    neighborhood: 'Redondo Beach', lat: 33.8492, lng: -118.388,
    description:
      'An antisemitic flyer directing readers to a hate website was found in a Ziploc bag weighted with rocks in Redondo Beach. Police said it followed several similar distributions in recent months and the investigation remained active.',
  ...
  {
    id: 'src-066', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-067', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-068', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-071', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-072', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2022-10-22T12:00:00Z', created_at: '2022-10-22T12:00:00Z',
  ...
  {
    id: 'src-073', category: 'harassment', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-076', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-078', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2022-05-21T12:00:00Z', created_at: '2022-05-21T12:00:00Z',
    neighborhood: 'West Hollywood', lat: 34.09, lng: -118.385,
    description:
      'Vehicles displaying antisemitic hate-speech messages were driven through West Hollywood over a weekend, prompting condemnation from city officials and review by the Sheriff\'s Department and neighboring Beverly Hills police.',
    source_name: 'CBS News Los Angeles', source_url: 'https://www.cbsnews.com/losangeles/news/antisemitic-messages-left-on-vehicles-in-west-hollywood/',
  },
  {
  ...
  {
    id: 'src-081', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-082', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-083', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-084', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-085', category: 'other', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2021-12-18T12:00:00Z', created_at: '2021-12-18T12:00:00Z',
    neighborhood: 'Pasadena', lat: 34.1625, lng: -118.129,
    description:
      'Antisemitic flyers linking COVID-19 to Jewish people were left in plastic bags on driveways across a four-block area of Pasadena near Washington Boulevard and Mentor Avenue. Pasadena police investigated and CAIR-LA condemned the materials.',
    source_name: 'Pasadena Now', source_url: 'https://pasadenanow.com/main/islamic-group-condemns-antisemitic-flyers',
  },
  {
    id: 'src-086', category: 'harassment', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2021-10-07T12:00:00Z', created_at: '2021-10-07T12:00:00Z',
    neighborhood: 'Santa Monica', lat: 34.0175, lng: -118.4695,
    description:
      'A Chabad rabbi\'s car was vandalized outside the Chabad at Santa Monica College with a swastika on one window and a Star of David with \'Is Illegal\' written on another, as the rabbi was taking down a sukkah.',
    source_name: 'Jewish Journal', source_url: 'https://jewishjournal.com/news/341239/santa-monica-college-chabad-rabbis-car-vandalized-with-swastika-graffiti/',
  },
  {
  ...
  {
    id: 'src-090', category: 'assault', severity: 'high', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-091', category: 'harassment', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2021-05-20T12:00:00Z', created_at: '2021-05-20T12:00:00Z',
  ...
  {
    id: 'src-092', category: 'assault', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-093', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
    occurred_at: '2021-04-20T12:00:00Z', created_at: '2021-04-20T12:00:00Z',
    neighborhood: 'Venice', lat: 33.9905, lng: -118.467,
    description:
      'The phrase "The Jew Is Guilty" was spray-painted in at least three spots on the sidewalk in the Abbot Kinney Boulevard area of Venice. A local resident documented and painted over the graffiti; Jewish organizations condemned it.',
    source_name: 'Jewish Journal', source_url: 'https://jewishjournal.com/news/335844/la-resident-spray-paints-over-the-jew-is-guilty-graffiti/',
  },
  {
  ...
  {
    id: 'src-096', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-097', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  },
  {
    ...
    occurred_at: '2020-05-30T12:00:00Z', created_at: '2020-05-30T12:00:00Z',
    neighborhood: 'Fairfax District', lat: 34.0762, lng: -118.366,
    description:
      'Congregation Beth Israel at 8056 Beverly Boulevard, one of the oldest synagogues in Los Angeles, was spray-painted with "Free Palestine" and profane anti-Israel graffiti during unrest in the area. Jewish organizations condemned the vandalism.',
    source_name: 'NBC Los Angeles', source_url: 'https://www.nbclosangeles.com/news/local/synagogue-vandalized-in-fairfax-district-amid-protests/2371400/',
  },
  {
    id: 'src-099', category: 'vandalism', severity: 'medium', source: 'LAPD', status: 'verified', campus_id: null,
  ...
  {
    id: 'src-100', category: 'vandalism', severity: 'low', source: 'LAPD', status: 'verified', campus_id: null,
